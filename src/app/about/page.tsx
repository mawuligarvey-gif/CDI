...
export default function About() {
  ...
  const team = [
    ...
    },
    {
      ...
      bio: "Emmanuel Vitashie is a program architect and research-driven leader, serving as Head of Programs & Research at Cultural Diplomat Impact Organization. He is known for his analytical rigor, systems thinking, and ability to translate vision into structured, high-impact initiatives. In his role, Emmanuel leads the design and execution of the organization's flagship programs, including impact conferences, internship initiatives, and partner-led projects. He drives the organization's research strategy while ensuring that ideas are developed into scalable, results-oriented interventions. His work sits at the intersection of strategy, data, and execution, enabling the delivery of innovative and measurable outcomes. He has contributed to impacting over 3,000 students and has supported strategic collaborations with institutions such as UPSA and the Pan African Leadership Institute. With a background in Medical Laboratory Science and an MSc in Genetic Counselling, he brings a multidisciplinary lens to program design and research. Emmanuel is committed to advancing transformative leadership through well-designed systems and continues to position himself as a thought leader in program development and execution.",
    },
    {
