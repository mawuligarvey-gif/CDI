    ...
    <div className="pt-20 min-h-screen bg-white">
      <section className="py-20 md:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-primary mb-8">Code of Conduct</h1>
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 leading-relaxed mb-6">
              We are committed to maintaining a respectful and safe environment.
            </p>

            <h2 className="text-2xl font-bold text-primary mt-8 mb-4">Expected Behavior</h2>
            ...
            <h2 className="text-2xl font-bold text-primary mt-8 mb-4">Unacceptable Behavior</h2>
            <ul className="list-disc pl-6 text-gray-700 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-primary mt-8 mb-4">Enforcement</h2>
