        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 leading-relaxed">
              If you have questions, contact us at: <a href="mailto:theculturaldiplomats@gmail.com" className="text-tertiary hover:underline">theculturaldiplomats@gmail.com</a>
            </p>
          </div>
        </div>
      </section>
